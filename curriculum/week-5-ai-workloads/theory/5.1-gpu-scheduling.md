...
> **How KAI Gang Scheduling Works:** Grouping depends on the scheduler version and installed workload integration. The plain batch/v1 Job in the pinned lab may get one PodGroup per pod and is not proof of a gang. Use a supported PyTorchJob integration or an explicit PodGroup, inspect minMember, and test under insufficient capacity.
...
MIG provides hardware-level GPU partitioning on A30, A100, H100, H200, B200, GB200, and newer GPUs:
